...
echo "Built: $OUT_LIB"
echo ""
echo "Add to hica.ini in your project:"
if [[ "$(uname)" == "Darwin" ]]; then
    echo "  [koka]"
    echo "  flags = -L./lib/imgui/lib --cclib=imgui_hica --cclib=SDL2 -framework OpenGL"
else
    echo "  [koka]"
    echo "  flags = -L./lib/imgui/lib --cclib=imgui_hica --cclib=SDL2 --cclib=GL"
fi
